    ...
    return (
        <section className='w-full'>
            ...
            <div className="items-parent flex items-center justify-between w-full">
                <div onClick={backWordScroll} className='text-3xl bg-orange-200 cursor-pointer font-bold hover:bg-orange-300 h-full hidden md:flex items-center justify-center py-4 md:py-9 md:px-2 rounded-md'>
                    <IoIosArrowBack />
                </div>
                <div ref={scrollContainerRef} className="items-container flex scroll-smooth gap-3 w-full md:w-[90%] mx-auto overflow-auto overflow-x-scroll">
                ...
                <div onClick={forwardScroll} className='text-3xl bg-orange-200 cursor-pointer font-bold hover:bg-orange-300 h-full hidden md:flex items-center justify-center py-4 py-4 md:py-9 md:px-2 rounded-md'>
                    <IoIosArrowForward />
                </div>
            </div>
